...
class EnvironmentHistory:
    ...
    def get_prompt(self) -> str:
        ...
        template_s += 'Start your response with your reasoning over the given context. Wisely select the information, conclude a clear market trend, and avoid being trivially conservative. Finally, your response ends with a 1-decimal float value, [-1,0) to buy if the trend is upwards, (0,1] to sell if the trend is downward, 0 to hold. Make sure to directly give the value at the very end and no explanation.'
