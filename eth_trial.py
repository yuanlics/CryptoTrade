...
# **Precision in Decision:** Ensure your decision is presented as a two-decimal value within the [-1, 1] range. This precision reflects the nuanced analysis and strategic thought behind your decision."
        base_prompt = f'You are a professional crypto currency trader and you are trying to maximize your overall profit. In each day, you will make an action represented by a precision-two float value in range [-1,1], such as -0.35, 0.77, -1.00, 1.00, 0.00, 0.95, -0.82, and so on. If action is in negative range [-1,0), you will spend this portion of cash at hand to buy ETH. If action is in positive range (0,1], you will sell this portion of holding ETH at hand. If action is 0, no action is taken and no transaction fee is charged. You will start with {info["starting_cash"]} dollars. Wisely analyze the current context to make decisions. \n'
